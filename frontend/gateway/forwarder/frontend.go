...
func (gf *GatewayForwarder) Solve(ctx context.Context, llbBridge frontend.FrontendLLBBridge, opts map[string]string, inputs map[string]*llb.Definition) (retRes *frontend.Result, retErr error) {
